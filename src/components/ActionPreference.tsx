  ...
  return (
    <div className="mt-2 flex flex-wrap items-center gap-x-3 gap-y-2">
      ...
      <button
        ...
        className="label rounded-control border border-line-strong px-2 py-1 text-[10px] font-semibold text-faint"
      >
...
function Step({
  ...
  return (
    <button
      ...
      disabled={disabled}
      aria-label={label}
      className="num h-8 w-8 rounded-control border border-line-strong text-[15px] text-ink disabled:opacity-30"
    >
      {children}
    </button>
  )
