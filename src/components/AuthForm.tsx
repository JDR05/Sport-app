    ...
    <form action={formAction} className="mt-6">
      ...
      <div className="mb-5">
        ...
        <input
          ...
          autoCapitalize="none"
          spellCheck={false}
          className="mt-2 w-full rounded-control border border-line bg-surface px-3 py-2.5 text-base text-ink outline-none placeholder:text-faint focus:border-accent"
        />
      </div>
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className="mt-2 w-full rounded-control border border-line bg-surface px-3 py-2.5 text-base text-ink outline-none focus:border-accent"
        />
      </div>

      {state.error && (
        <p role="alert" className="mb-4 rounded-control bg-warn-soft px-3 py-2.5 text-sm text-ink">
          {state.error}
        </p>
      )}
